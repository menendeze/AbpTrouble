...
using Abp.Owin;
using ecomercialapp.Api.Controllers;
using ecomercialapp.Web;
...
namespace ecomercialapp.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in ecomercialappWebModule)
